...
const AudioSVG = (props) => {
    ...
    return (<div className='display-1 text-white'>
            STATUS = {status}
            TIME = {currTime}
            <button id='audioButton' className='audio-button mb-5 bg-transparent border-0' onMouseDown={handleMouseDown} onMouseUp={handleMouseUp} onContextMenu={(e)=> e.preventDefault()} holdToDisplay={-1}>
